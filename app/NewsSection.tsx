...
function getFallbackImage(source: string) {
  const map: any = {
    CoinDesk:
      "https://www.coindesk.com/favicons/production/favicon.svg",
    CoinTelegraph:
      "https://cointelegraph.com/_platypus/img/icons/ct-logo.svg",
    Decrypt:
      "https://cdn.decrypt.co/wp-content/themes/decrypt-media/assets/images/branding-2024/full-logo-black.svg",
  };
